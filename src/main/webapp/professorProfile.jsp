...
<div class="app">
    ...
    <div class="container w-50 p-5" style="background-color: #2C3964">
        <form method="post">
            ...
            <div class="form-group">
                <label class="text-light" for="oldPasswordInput" >Old Password</label>
                <input type="password" class="form-control " name="oldpassword"  id="oldPasswordInput" placeholder="Old Password">
            </div>
            <div class="form-group">
                <label class="text-light" for="newPasswordInput" >New Password</label>
